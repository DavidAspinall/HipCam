...
let REWRITE_CONV thl tm =
  hilabel_thm_str "REWRITE_CONV" (REWRITE_CONV thl tm);;
...
let GEN_REWRITE_TAC cnvl thl = hilabel_tac_str "GEN_REWRITE_TAC" (GEN_REWRITE_TAC cnvl thl);;

let PURE_REWRITE_TAC thl = CONV_TAC(PURE_REWRITE_CONV thl);;

let REWRITE_TAC thl = CONV_TAC(REWRITE_CONV thl);;

let REWRITE_TAC thl = hilabel_tac_str "REWRITE_TAC" (REWRITE_TAC thl);;

let PURE_ONCE_REWRITE_TAC thl = CONV_TAC(PURE_ONCE_REWRITE_CONV thl);;

let ONCE_REWRITE_TAC thl = CONV_TAC(ONCE_REWRITE_CONV thl);;

let ONCE_REWRITE_TAC thl = hilabel_tac_str "ONCE_REWRITE_TAC" (ONCE_REWRITE_TAC thl);;
...
let ASM_REWRITE_TAC thl = hilabel_tac_str "ASM_REWRITE_TAC" (ASM_REWRITE_TAC thl);;
...
let SIMP_TAC thl = hilabel_tac_str "SIMP_TAC" (SIMP_TAC thl);;
...
let ASM_SIMP_TAC thl = hilabel_tac_str "ASM_SIMP_TAC" (ASM_SIMP_TAC thl);;
