...
let BETA_CONV tm = hilabel_thm_str "BETA_CONV" (BETA_CONV tm);;
...
let SYM th = hilabel (string_label "SYM") (fun ths -> SYM (List.hd ths)) [th];;

let ALPHA tm1 tm2 =
  try TRANS (REFL tm1) (REFL tm2)
  with Failure _ -> failwith "ALPHA";;

let ALPHA tm1 tm2 = hilabel_thm_str "ALPHA" (ALPHA tm1 tm2);;
